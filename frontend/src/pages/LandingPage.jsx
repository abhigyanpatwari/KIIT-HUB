...
const LandingPage = () => {
  ...
  return (
    <div className={`${isDark ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} transition-colors duration-300`}>
      <div className={`flex flex-col-reverse ${isDark ? 'bg-gray-800' : 'bg-slate-300'} h-fit lg:h-[20rem] xl:h-[27rem] md:bg-backSm_1 lg:bg-backLg bg-no-repeat sm:flex-row pb-[5%] sm:pb-0 transition-colors duration-300`}>
        <div className="px-[5%] md:h-[70vh] sm:mb-0 sm:p-[2%] sm:pl-[5%] sm:pr-[2%] w-[100vw] sm:h-[50vh] mt-3 sm:mt-0 text-center">
          ...
          <div className={`${isDark ? 'text-blue-300 font-medium' : 'text-blue-900'} mb-[2rem] transition-colors duration-300`}>
            Connect with your mates to get items at cheaper price
          </div>
          <button 
            onClick={() => { navigate('/home') }} 
            className="rounded-md bg-blue-500 p-[1%] hover:bg-blue-600 text-white transition-colors duration-300"
          >
      ...
      <div className="flex">
        ...
        <div className="lg:bg-circle bg-no-repeat w-[100%]">
          <div className="w-[100%] p-[2rem] bg-transparent md:bg-road bg-no-repeat bg-center bg-auto">
            <div className={`text-center font-bold text-[150%] ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>Roadmap</div>
            <div className="mt-0 lg:mt-[5rem]">
              <div className="flex my-3 md:mr-[58%] lg:mr-[48%] mt-3 md:mt-[5rem]">
                <div className="self-center mr-[5%] text-right md:ml-[18%]">
                  ...
                  <div className={`text-semibold text-[120%] ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>
                    Find Your Spare Items
                  </div>
                  <div className={`text-xs ${isDark ? 'text-blue-200' : 'text-slate-500'}`}>                  
